...
# -*- coding: utf-8 -*-
"""
discogs_to_shopify_gui_v1.2.0.py
...
DISCOGS_USER_AGENT = "UnusualFindsDiscogsToShopify/1.2.0 +https://unusualfinds.com"
...
class DiscogsToShopifyGUI:
    ...
    def run_process(self) -> None:
        ...
        try:
            # Minimal logging inside the GUI; detailed logs still go to console if needed
            logging.basicConfig(
                level=logging.INFO,
